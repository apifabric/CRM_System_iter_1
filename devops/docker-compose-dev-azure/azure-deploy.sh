...
resourcename="crmsystemiter1"  # lower case, only
resourcegroup="crmsystemiter1_rg"
...
# git clone https://github.com/apilogicserver/crmsystemiter1.git
# cd crmsystemiter1
...
az group create --name crmsystemiter1_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group crmsystemiter1_rg --sku S1 --is-linux
az container create --resource-group crmsystemiter1_rg --name crmsystemiter1 --image apilogicserver/crmsystemiter1:latest --dns-name-label crmsystemiter1 --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//crmsystemiter1.westus.azurecontainer.io:5656'
